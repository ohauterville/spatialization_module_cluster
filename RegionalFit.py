...
class RegionalFit:
    def __init__(self, name, parent_x, parent_y,):
        ...
        self.initial_guess = [50, 0.0003, 18000] 
        self.bounds = [(10, 250), (0.0001, 0.001), (10000, None)]
        self.nb_vars = 3
    ...
    def optimize(self):
        ...
        # Initial guess
        initial_guess = self.initial_guess * len(self.data_x)

        bounds = self.bounds * len(self.data_x)
